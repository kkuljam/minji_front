...
//=================함수 밖에 선언==================
    // 여럿 함수들 { }에서 사용하기 때문에. // 선언 1번하고 누적 저장
const idArray = []; // 1. 아이디 저장하는 배열
const pwArray = []; // 2. 패스워드 저장하는 배열

//=========== 1. 회원가입 함수=====
function 회원가입(){// f start // 선언부 // 실행조건 : 가입버튼[<input type="button">]을 클릭했을 때
    console.log("가입버튼")
...
//============2. 로그인 함수=====
function 로그인 (){//f start // 선언부 // 실행조건 : 로그인버튼 [<input type="button">]을 클릭했을 때
    console.log("로그인버튼")
    //1. [압력]
