...
document.addEventListener('DOMContentLoaded',function(){
    ...
    setTimeout(function(){
        ...
        console.log(h2.parentNode)// 객체명.parentNode : 해당 객체의 부모 => body
        h2.parentNode.removeChild(h2); 
        
    },3000); //300=> 3초 후에 익명함수 실행
    ...
    h3.addEventListener('click', function(event){
        ...
        //2. 그 이벤트를 발생한 *결과 내용(객체)을 콜백함수의 매개변수로 전달.
